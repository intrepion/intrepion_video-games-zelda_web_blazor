...
[TestFixture]
public partial class EmulatorAdminPages : PageTest
{
    [Test]
    public async Task MainNavigation()
    {
        ...
        await Page.GetByTestId("emulatorNavLink").ClickAsync();
        await Expect(Page).ToHaveTitleAsync("Emulator Home");
        await Page.GetByRole(AriaRole.Link, new() { Name = "Create New" }).ClickAsync();
        await Expect(Page).ToHaveTitleAsync("Emulator Add");
        ...
        await Expect(Page).ToHaveTitleAsync("Emulator View");
        await Page.GetByRole(AriaRole.Link, new() { Name = "Edit" }).ClickAsync();
        await Expect(Page).ToHaveTitleAsync("Emulator Edit");
