...
[TestFixture]
public partial class EmulatorCoreAdminPages : PageTest
{
    [Test]
    public async Task MainNavigation()
    {
        ...
        await Page.GetByTestId("emulatorCoreNavLink").ClickAsync();
        await Expect(Page).ToHaveTitleAsync("Emulator Core Home");
        await Page.GetByRole(AriaRole.Link, new() { Name = "Create New" }).ClickAsync();
        await Expect(Page).ToHaveTitleAsync("Emulator Core Add");
        ...
        await Expect(Page).ToHaveTitleAsync("Emulator Core View");
        await Page.GetByRole(AriaRole.Link, new() { Name = "Edit" }).ClickAsync();
        await Expect(Page).ToHaveTitleAsync("Emulator Core Edit");
