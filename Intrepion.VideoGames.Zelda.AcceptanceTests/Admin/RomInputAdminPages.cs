...
[TestFixture]
public partial class RomInputAdminPages : PageTest
{
    [Test]
    public async Task MainNavigation()
    {
        ...
        await Page.GetByTestId("romInputNavLink").ClickAsync();
        await Expect(Page).ToHaveTitleAsync("Rom Input Home");
        await Page.GetByRole(AriaRole.Link, new() { Name = "Create New" }).ClickAsync();
        await Expect(Page).ToHaveTitleAsync("Rom Input Add");
        ...
        await Expect(Page).ToHaveTitleAsync("Rom Input View");
        await Page.GetByRole(AriaRole.Link, new() { Name = "Edit" }).ClickAsync();
        await Expect(Page).ToHaveTitleAsync("Rom Input Edit");
