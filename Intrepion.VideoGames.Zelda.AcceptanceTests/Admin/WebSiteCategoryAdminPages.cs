...
[TestFixture]
public partial class WebSiteCategoryAdminPages : PageTest
{
    [Test]
    public async Task MainNavigation()
    {
        ...
        await Page.GetByTestId("webSiteCategoryNavLink").ClickAsync();
        await Expect(Page).ToHaveTitleAsync("WebSiteCategory Home");
        await Page.GetByRole(AriaRole.Link, new() { Name = "Create New" }).ClickAsync();
        await Expect(Page).ToHaveTitleAsync("WebSiteCategory Add");
        ...
        await Expect(Page).ToHaveTitleAsync("WebSiteCategory View");
        await Page.GetByRole(AriaRole.Link, new() { Name = "Edit" }).ClickAsync();
        await Expect(Page).ToHaveTitleAsync("WebSiteCategory Edit");
