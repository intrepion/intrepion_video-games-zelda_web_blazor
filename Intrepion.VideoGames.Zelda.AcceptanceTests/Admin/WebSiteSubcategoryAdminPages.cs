...
[TestFixture]
public partial class WebSiteSubcategoryAdminPages : PageTest
{
    [Test]
    public async Task MainNavigation()
    {
        ...
        await Page.GetByTestId("webSiteSubcategoryNavLink").ClickAsync();
        await Expect(Page).ToHaveTitleAsync("WebSite Subcategory Home");
        await Page.GetByRole(AriaRole.Link, new() { Name = "Create New" }).ClickAsync();
        await Expect(Page).ToHaveTitleAsync("WebSite Subcategory Add");
        ...
        await Expect(Page).ToHaveTitleAsync("WebSite Subcategory View");
        await Page.GetByRole(AriaRole.Link, new() { Name = "Edit" }).ClickAsync();
        await Expect(Page).ToHaveTitleAsync("WebSite Subcategory Edit");
