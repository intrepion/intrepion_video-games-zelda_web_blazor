        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NormalizedCode = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UpdateDateTime = table.Column<DateTime>(type: "datetime2", nullable: false),
                    IsTest = table.Column<bool>(type: "bit", nullable: false),
                    RomStateId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_RomTexts_RomStates_RomStateId",
                        column: x => x.RomStateId,
                        principalTable: "RomStates",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UpdateDateTime = table.Column<DateTime>(type: "datetime2", nullable: false),
                    IsTest = table.Column<bool>(type: "bit", nullable: false),
                    PreviousRomStateId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    RomInputId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    RomStateId = table.Column<Guid>(type: "uniqueidentifier", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_RomTransitions_RomInputs_RomInputId",
                        column: x => x.RomInputId,
                        principalTable: "RomInputs",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_RomTransitions_RomStates_PreviousRomStateId",
                        column: x => x.PreviousRomStateId,
                        principalTable: "RomStates",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_RomTransitions_RomStates_RomStateId",
                        column: x => x.RomStateId,
                        principalTable: "RomStates",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_WebSiteCategories_WebSites_WebSiteId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NormalizedName = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    WebSiteId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    WebSiteCategoryId = table.Column<Guid>(type: "uniqueidentifier", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_WebSiteSubcategories_WebSiteCategories_WebSiteCategoryId",
                        column: x => x.WebSiteCategoryId,
                        principalTable: "WebSiteCategories",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_WebSiteSubcategories_WebSites_WebSiteId",
                        column: x => x.WebSiteId,
                        principalTable: "WebSites",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Roms_WebSites_WebSiteId",
                        column: x => x.WebSiteId,
                        principalTable: "WebSites",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RomTransitions_PreviousRomStateId",
                table: "RomTransitions",
                column: "PreviousRomStateId");

            migrationBuilder.CreateIndex(
                name: "IX_RomTransitions_RomInputId",
                table: "RomTransitions",
                column: "RomInputId");

            migrationBuilder.CreateIndex(
                name: "IX_RomTransitions_RomStateId",
                table: "RomTransitions",
                column: "RomStateId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_WebSiteCategories_WebSiteId",
                table: "WebSiteCategories",
                column: "WebSiteId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_WebSiteSubcategories_WebSiteCategoryId",
                table: "WebSiteSubcategories",
                column: "WebSiteCategoryId");

            migrationBuilder.CreateIndex(
                name: "IX_WebSiteSubcategories_WebSiteId",
                table: "WebSiteSubcategories",
                column: "WebSiteId");
        }
